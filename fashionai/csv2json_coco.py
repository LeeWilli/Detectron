...
for data in imported_data:
    ...
    ann['category_id'] = int(categories[data[1]])
    ann['keypoints'], ann['num_keypoints'] = to_coco_keypoints(data[2:])
    #ann['num_keypoints'] = 24
    bbox, area = find_convex_box(ann['keypoints'])
    ann['bbox'] = bbox
    ann['area'] = area
    #print("bbox:", bbox)
    #print("area:", area)
    #print('area:', 22)
    ann['segmentation'] = []#box2segment(ann['bbox'])
    ann['iscrowd'] = 0
    ann['id'] = image_id
